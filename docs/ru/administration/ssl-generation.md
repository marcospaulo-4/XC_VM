<h1 align="center">🔒 Генерация SSL-сертификата для Nginx в XC_VM</h1>

<p align="center">
  В этом документе описан процесс <b>создания самоподписанного SSL-сертификата. Следуйте шагам, чтобы настроить безопасное HTTPS-соединение.
</p>
