        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><?= $language::get('enigma_devices') ?></h4>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body" style="overflow-x:auto;">
                        <div id="collapse_filters" class="<?= $rMobile ? 'collapse' : '' ?> form-group row mb-4">
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="e2_search" value="<?= isset($rRequest['search']) ? htmlspecialchars($rRequest['search']) : '' ?>" placeholder="<?= $language::get('search_devices') ?>...">
                            </div>
                            <label class="col-md-2 col-form-label text-center" for="e2_reseller"><?= $language::get('filter_results') ?></label>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <select id="e2_filter" class="form-control" data-toggle="select2">
                                    ...
                                    <option value="4"<?= (isset($rRequest['filter']) && $rRequest['filter'] == 3) ? ' selected' : '' ?>><?= $language::get('expired') ?></option>
                                    <option value="5"<?= (isset($rRequest['filter']) && $rRequest['filter'] == 4) ? ' selected' : '' ?>><?= $language::get('trial') ?></option>
                                </select>
                            </div>
                            <label class="col-md-1 col-form-label text-center" for="e2_show_entries"><?= $language::get('show') ?></label>
                            <div class="col-md-1">
