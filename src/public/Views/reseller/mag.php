<?php
/**
 * MAG device — clean view template.
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"><?= isset($rDevice) ? 'Edit' : 'Add' ?><?php if (isset($rRequest['trial'])) echo ' Trial'; ?> MAG Device</h4>
                </div>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="sn" name="sn" value="<?= htmlspecialchars($rDevice['sn']) ?>">
                                                    </div>
                                                    <label class="col-md-2 col-form-label" for="stb_type">STB Type</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="stb_type" name="stb_type" value="<?= htmlspecialchars($rDevice['stb_type']) ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="image_version">Image Version</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="image_version" name="image_version" value="<?= htmlspecialchars($rDevice['image_version']) ?>">
                                                    </div>
                                                    <label class="col-md-2 col-form-label" for="hw_version">HW Version</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" id="hw_version" name="hw_version" value="<?= htmlspecialchars($rDevice['hw_version']) ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="device_id">Primary Device ID</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="device_id" name="device_id" value="<?= htmlspecialchars($rDevice['device_id']) ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="device_id2">Secondary Device ID</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="device_id2" name="device_id2" value="<?= htmlspecialchars($rDevice['device_id2']) ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="ver">Version</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" id="ver" name="ver" value="<?= htmlspecialchars($rDevice['ver']) ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
