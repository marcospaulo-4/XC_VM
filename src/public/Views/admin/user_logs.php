...
echo "\t\t\t\t\t\t\t\t" . '</select>' . "\r\n\t\t\t\t\t\t\t" . '</div>' . "\r\n" . '                            <label class="col-md-1 col-form-label text-center" for="range">' . $language::get('dates') . '</label>' . "\r\n\t\t\t\t\t\t\t" . '<div class="col-md-2">' . "\r\n\t\t\t\t\t\t\t\t" . '<input type="text" class="form-control text-center date" id="range" name="range" data-toggle="date-picker" data-single-date-picker="true" autocomplete="off" placeholder="' . $language::get('all_dates') . '">' . "\r\n\t\t\t\t\t\t\t" . '</div>' . "\r\n" . '                            <label class="col-md-1 col-form-label text-center" for="range">' . $language::get('show') . '</label>' . "\r\n\t\t\t\t\t\t\t" . '<div class="col-md-1">' . "\r\n\t\t\t\t\t\t\t\t" . '<select id="show_entries" class="form-control" data-toggle="select2">' . "\r\n\t\t\t\t\t\t\t\t\t";
...
echo "\t\t\t\t\t\t\t\t" . '</select>' . "\r\n\t\t\t\t\t\t\t" . '</div>' . "\r\n\t\t\t\t\t\t" . '</div>' . "\r\n\t\t\t\t\t\t" . '<table id="datatable-activity" class="table table-striped table-borderless dt-responsive nowrap">' . "\r\n\t\t\t\t\t\t\t" . '<thead>' . "\r\n\t\t\t\t\t\t\t\t" . '<tr>' . "\r\n\t\t\t\t\t\t\t\t\t" . '<th class="text-center">' . $language::get('id') . '</th>' . "\r\n\t\t\t\t\t\t\t\t\t" . '<th>' . $language::get('reseller') . '</th>' . "\r\n\t\t\t\t\t\t\t\t\t" . '<th>' . $language::get('line_device') . '</th>' . "\r\n\t\t\t\t\t\t\t\t\t" . '<th>' . $language::get('action') . '</th>' . "\r\n" . '                                    <th class="text-center">' . $language::get('cost') . '</th>' . "\r\n" . '                                    <th class="text-center">' . $language::get('credits_remaining') . '</th>' . "\r\n\t\t\t\t\t\t\t\t\t" . '<th class="text-center">' . $language::get('date') . '</th>' . "\r\n\t\t\t\t\t\t\t\t" . '</tr>' . "\r\n\t\t\t\t\t\t\t" . '</thead>' . "\r\n\t\t\t\t\t\t\t" . '<tbody></tbody>' . "\r\n\t\t\t\t\t\t" . '</table>' . "\r\n\t\t\t\t\t" . '</div> ' . "\r\n\t\t\t\t" . '</div> ' . "\r\n\t\t\t" . '</div>' . "\r\n\t\t" . '</div>' . "\r\n\t" . '</div>' . "\r\n" . '</div>' . "\r\n";
