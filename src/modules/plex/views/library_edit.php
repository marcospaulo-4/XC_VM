                ...
                <div class="card">
                    <div class="card-body">
                        <form action="#" method="POST" data-parsley-validate="">
                            ...
                            <?php endif; ?>
                            <input type="hidden" name="libraries" id="libraries"
                                value="<?= isset($rFolder['plex_libraries']) ? htmlspecialchars($rFolder['plex_libraries']) : ''; ?>" />
                            <div id="basicwizard">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="server_id">Server
                                                        Name</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" id="plex_ip" name="plex_ip" class="form-control"
                                                            value="<?= isset($rFolder) ? $rFolder['plex_ip'] : ''; ?>" placeholder="Server IP" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <input type="text" id="plex_port" name="plex_port" class="form-control text-center"
                                                            value="<?= isset($rFolder) ? $rFolder['plex_port'] : ''; ?>" placeholder="Port" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="username" name="username" class="form-control"
                                                            value="<?= isset($rFolder) ? $rFolder['plex_username'] : ''; ?>" placeholder="Username" required
                                                            data-parsley-trigger="change">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="password" id="password" name="password" class="form-control"
                                                            value="<?= isset($rFolder) ? $rFolder['plex_password'] : ''; ?>" placeholder="Password">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-1">
                                                        <button class="btn btn-primary waves-effect waves-light" type="button" id="scanPlex"><i
                                                ...
                                                <div class="form-group row mb-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input name="active" id="active" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['active'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                    <label class="col-md-4 col-form-label" for="direct_proxy">Direct Stream <i
                                                            title="When using direct source, hide the original Plex URL by proxying the movie through your servers. This will consume bandwidth but won't require the movie to be saved to your servers permanently."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="direct_proxy" id="direct_proxy" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['direct_proxy'])) {
                                                                echo 'checked ';
                                                            } ?>data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="settings">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="read_native">Native
                                                        Frames <i title="Read input video at native frame rate."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="read_native" id="read_native" type="checkbox"
                                                            <?php if (isset($rFolder) && $rFolder['read_native']) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                    <label class="col-md-4 col-form-label" for="movie_symlink">Create
                                                        Symlink <i
                                                            title="Generate a symlink to the original file instead of encoding. File needs to exist on all selected servers."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="movie_symlink" id="movie_symlink" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['movie_symlink'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="auto_encode">Auto-Encode
                                                        <i title="Start encoding as soon as the movie is added."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="auto_encode" id="auto_encode" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['auto_encode'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                    <label class="col-md-4 col-form-label" for="scan_missing">Scan Missing
                                                        ID's <i
                                                            title="Check all Plex ID's in the XC_VM database against Plex database and scan missing items too. If this is off, XC_VM will only request items modified after the last scan date. Turning this on will increase time taken to scan as the entire library needs to be scanned instead of the recent items."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="scan_missing" id="scan_missing" type="checkbox"
                                                            <?php if (isset($rFolder) && $rFolder['scan_missing']) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="auto_upgrade">Auto-Upgrade
                                                        Quality <i
                                                            title="Automatically upgrade quality if the system finds a new file with better quality that has the same Plex or TMDb ID."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="auto_upgrade" id="auto_upgrade" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['auto_upgrade'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                    <label class="col-md-4 col-form-label" for="store_categories">Store
                                                        Categories <i
                                                            title="Save unrecognised categories to Plex Settings, this will allow you to allocate a category after the first run and it will then be added on the second run."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="store_categories" id="store_categories" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['store_categories'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="check_tmdb">Check Against
                                                        TMDb <i
                                                            title="If the item has a TMDb ID, check it against the database to ensure duplicates aren't created due to previous content in the XC_VM system."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="check_tmdb" id="check_tmdb" type="checkbox"
                                                            <?php if (!isset($rFolder) || (isset($rFolder) && $rFolder['check_tmdb'])) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                    <label class="col-md-4 col-form-label" for="remove_subtitles">Remove
                                                        Existing Subtitles <i
                                                            title="Remove existing subtitles from file before encoding. You can't remove hardcoded subtitles using this method."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <input name="remove_subtitles" id="remove_subtitles" type="checkbox"
                                                            <?php if (isset($rFolder) && $rFolder['remove_subtitles']) {
                                                                echo 'checked ';
                                                            } ?> data-plugin="switchery" class="js-switch" data-color="#039cfd" />
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="target_container">
                                                        <?= $language::get('target_container'); ?> <i
                                                            title="Which container to use when transcoding files."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-2">
                                                        <select name="target_container" id="target_container" class="form-control"
                                                            data-toggle="select2">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="override_bouquets">Override
                                                        Bouquets</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="fallback_bouquets">Fallback
                                                        Bouquets</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row mb-4" id="override_category">
                                                    <label class="col-md-4 col-form-label" for="override_category">Override
                                                        Category</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row mb-4" id="fallback_category">
                                                    <label class="col-md-4 col-form-label" for="fallback_category">Fallback
                                                        Category</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-md-4 col-form-label" for="transcode_profile_id">Transcoding
                                                        Profile <i
                                                            title="Select a transcoding profile to autoamtically encode videos."
                                                            class="tooltip text-secondary far fa-circle"></i></label>
                                                    <div class="col-md-8">
                                        ...
                                        <ul class="list-inline wizard mb-0">
                                            ...
                                            <li class="list-inline-item float-right">
                                                <input name="submit_folder" type="submit" class="btn btn-primary"
                                                    value="<?= isset($rFolder) ? 'Edit' : 'Add'; ?>" />
                                            </li>
                                        </ul>
                                    </div>
                                </div>
